...
<table class="table table-striped">
  ...
  <tbody>
    ...
    $i=0;
     ...
     echo '<td> <button type="button" class="btn btn-primary"> <a style="color: white" href="edit_course_page.php?'.http_build_query($whole_array). '" target="_self" > Edit </a> </button> </td>';
     echo '<td> <button type="button" class="btn btn-primary"><a style="color: white" href="delete_course_page.php?'.http_build_query($whole_array). '" target="_self" > Delete </a></button> </td>';
